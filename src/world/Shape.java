...
public abstract class Shape {
	...
	/**
	 * This is a template method used to enforce the printing of text if the shape has text
	 * @param painter the Painter object used for drawing.
	 */
	public final void thePaint(Painter painter) {
		// 
		paint(painter);
		if (_theText != null) {
			painter.drawCenteredText(_theText, _x, _y, _width, _height);
		}
	}
